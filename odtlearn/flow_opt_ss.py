...
class FlowOPTSingleSink(OptimalPrescriptiveTree):
    ...
    Methods
    -------
    :meth:`_tree_struc_variables <odtlearn.flow_opt_ss.FlowOPTSingleSink._tree_struc_variables>`()
        Defines the decision variables related to the tree structure.
    :meth:`_flow_variables <odtlearn.flow_opt_ss.FlowOPTSingleSink._flow_variables>`()
        Defines the decision variables related to the flow of datapoints.
    :meth:`_define_variables <odtlearn.flow_opt_ss.FlowOPTSingleSink._define_variables>`()
        Defines all the decision variables used in the optimization problem.
    :meth:`_tree_structure_constraints <odtlearn.flow_opt_ss.FlowOPTSingleSink._tree_structure_constraints>`()
        Defines the constraints related to the tree structure.
    :meth:`_flow_constraints <odtlearn.flow_opt_ss.FlowOPTSingleSink._flow_constraints>`()
        Defines the constraints related to the flow of datapoints.
    :meth:`_define_constraints <odtlearn.flow_opt_ss.FlowOPTSingleSink._define_constraints>`()
