...
class FairOCT:
    ...
    def create_primal_problem(self):
        ...
        self.w = self.model.addVars(self.tree.Nodes + self.tree.Leaves, self.labels, vtype=GRB.CONTINUOUS, lb=0,
                                       name='w')
        ...
        for n in self.tree.Nodes + self.tree.Leaves:
            self.model.addConstrs(
                self.zeta[i, n, k] <= self.w[n, k] for i in self.datapoints for k in self.labels)
